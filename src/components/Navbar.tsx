    ...
    <header className="sticky top-0 z-30 liquid-header backdrop-blur-3xl w-full transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="font-extrabold text-base sm:text-xl tracking-tight text-slate-900 dark:text-[#FFFFFF] font-display">
                Law<span className="text-orange-500 dark:text-orange-400">Sphere</span>
              </span>
            ...
            <p className="text-[11px] text-slate-500 dark:text-[#777777] hidden sm:block -mt-0.5 font-medium truncate">
              National Legal Information & Statutory Reference
            </p>
          </div>
        </motion.div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <div className="hidden md:flex items-center p-1 rounded-2xl liquid-pill text-xs font-medium min-h-[44px]">
            <motion.button
              whileTap={{ scale: 0.94 }}
              onClick={() => setExplanationMode('simple')}
              className={`flex items-center gap-1.5 px-3 py-2 min-h-[38px] rounded-xl cursor-pointer liquid-select-item transition-all duration-200 select-none ${
          ...
          <motion.button
            ...
            onMouseEnter={preloadOnboarding}
            onTouchStart={preloadOnboarding}
            onFocus={preloadOnboarding}
            className="hidden sm:flex items-center gap-1.5 min-h-[44px] px-3.5 py-2 rounded-full liquid-pill text-xs font-semibold text-slate-700 dark:text-[#B3B3B3] cursor-pointer liquid-select-item group transition-all"
          ...
          <motion.button
            ...
            className="hidden sm:flex items-center gap-1.5 min-h-[44px] px-3 py-2 rounded-full liquid-pill text-xs font-semibold text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 transition-colors cursor-pointer border border-amber-500/25"
            title="Play Official Portal Intro"
          >
          ...
          <motion.button
            ...
            className="hidden md:flex items-center gap-1.5 min-h-[44px] px-3 py-2 rounded-full liquid-pill text-xs font-semibold text-slate-700 dark:text-[#B3B3B3] hover:text-slate-900 dark:hover:text-white border border-slate-200/80 dark:border-white/10 cursor-pointer liquid-select-item group transition-all"
            title="Ingest raw Bare Act / law book text into database"
            id="nav-ingest-law-btn"
          >
          ...
          <div className="relative" ref={themeMenuRef}>
            ...
            >
              ...
              <span className="hidden lg:inline text-xs font-semibold">
                {theme === 'day' ? 'Day' : theme === 'night' ? 'Night' : 'System'}
              </span>
            </motion.button>
          ...
          <motion.button
            ...
            className="sm:hidden min-h-[44px] min-w-[44px] flex items-center justify-center p-2 rounded-full liquid-pill text-slate-700 dark:text-[#B3B3B3] cursor-pointer"
          ...
          {user ? (
            <motion.button
              ...
              className="flex items-center gap-2 min-h-[44px] pl-2 pr-3.5 py-1.5 rounded-full liquid-pill cursor-pointer"
            ...
            <motion.button
              ...
              className="flex items-center gap-1.5 min-h-[44px] px-4 py-2 rounded-full bg-orange-500 hover:bg-orange-600 dark:bg-[#7C5CFF] dark:hover:bg-[#6c48f5] text-white font-medium text-xs shadow-md shadow-orange-500/20 dark:shadow-[#7C5CFF]/25 transition-all cursor-pointer"
            >
